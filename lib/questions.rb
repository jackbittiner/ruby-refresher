...
def select_elements_starting_with_a(array)
  array_a = []
  array.map {|x| array_a << x if x[0] == 'a'}
  return array_a
end
...
def select_elements_starting_with_vowel(array)
  array_vowel = []
  array.map do |word| array_vowel << word if word.start_with? 'a', 'e', 'i', 'o', 'u'
  end
  return array_vowel
end
...
def separate_array_into_even_and_odd_numbers(array)
  array_even = []
  array_odd = []
  array.each {|num| num % 2 == 0 ? array_even << num : array_odd << num}
  final_array = [array_even, array_odd]
end
...
def number_of_elements_that_are_palindromes(array)
  palindromes = []
  array.each {|word| palindromes << word if word == word.reverse}
  palindromes.length
end
...
def get_all_letters_in_array_of_words(array)
  list_of_letters = []
  array.each {|word| list_of_letters << word.split("")}
  list_of_letters.flatten.sort
end
